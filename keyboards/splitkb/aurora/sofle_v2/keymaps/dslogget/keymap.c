...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAVIGATION] = LAYOUT(
        ...
        _______, _______, KC_KP_7, KC_KP_8, KC_KP_9, _______,                   _______, _______, KC_UP, KC_PGUP, KC_PGUP, _______,
        _______, KC_KP_0, KC_KP_4, KC_KP_5, KC_KP_6, _______,                   KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END, _______,
        _______, _______, KC_KP_1, KC_KP_2, KC_KP_3, _______, _______, _______, _______, _______, _______, KC_PGDN, _______, _______,
                          _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______
    ),
    [_SYMBOLS] = LAYOUT(
